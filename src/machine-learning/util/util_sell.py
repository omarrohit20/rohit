...
#             add_in_csv(regression_data, regressionResult, ws, None, None, None, None, 'TestmayBuyShortDownTrend') 
    ...
    if(('downTrend' in regression_data['series_trend'] or 'DownTrend' in regression_data['series_trend'])
        ...
        if(regression_data['PCT_day_change'] < -2 and abs(regression_data['monthLowChange']) < abs(regression_data['monthHighChange'])
        ...
        if(0 < regression_data['PCT_day_change_pre1'] < 2
            ...
            if(regression_data['PCT_day_change_pre2'] < -2 or regression_data['PCT_day_change_pre3'] < -2):
                add_in_csv(regression_data, regressionResult, ws, None, None, 'mayContinueShortDownTrend-PCTDayChangePre1GT0')
            flag = True
    ...
    if(regression_data['PCT_day_change'] > 0
        ...
        if(0 < regression_data['PCT_change'] < 1.5
           ...
           add_in_csv(regression_data, regressionResult, ws, None, None, None, None,'RISKY-DOWNTREND-BUY:[DOWNTRENDMARKET-Sell]')
           ...
           and regression_data['year2LowChange'] > 5
            ...
            if((regression_data['PCT_day_change_pre1'] > -1 and abs(regression_data['PCT_day_change_pre1']) > abs(regression_data['PCT_day_change']))
                ...
                add_in_csv(regression_data, regressionResult, ws, None, None, None, None,'RISKY-DOWNTREND-BUY:[DOWNTRENDMARKET-Sell,UPTRENDMARKET:checkForUptrendContinueInGLOBALMARKETUP]')
        ...
        if(((regression_data['weekHighChange'] < -2 and regression_data['weekLowChange'] > 1.5)
            ...
            add_in_csv(regression_data, regressionResult, ws, None, None, None, None,'RISKY-DOWNTREND-BUY:DOWNTREND-GLOBALDOWN:checkForDowntrendContinueLastDayUp')
        ...
        if(regression_data['PCT_change'] > 0
            ...
            if(regression_data['PCT_day_change'] > 4 and regression_data['PCT_change'] > 4):
                add_in_csv(regression_data, regressionResult, ws, None, None, None, None, 'RISKY-DOWNTREND-BUY:DOWNTRENDMARKET:checkForDowntrendContinueLastDayUp')
        ...
        if(regression_data['PCT_change'] > -1
            ...
            add_in_csv(regression_data, regressionResult, ws, None, None, None, None, 'RISKY-DOWNTREND-BUY:DOWNTRENDMARKET:checkForDowntrendContinueLastDayDownPCT10GT-0.5') 
    ...
    if(regression_data['monthLowChange'] < 4 and regression_data['week2LowChange'] < 4 and regression_data['weekLowChange'] < 4
        ...
        add_in_csv(regression_data, regressionResult, ws, None, None, None, None, 'mayMorningSell-LastDayUp-DownTrend')
        flag = True
        ...
        add_in_csv(regression_data, regressionResult, ws, None, None, None, None, 'Risky:mayMorningSell-LastDayUp-DownTrend')
        flag = True
...
def sell_down_trend(regression_data, regressionResult, reg, ws):
    ...
    if(0 < regression_data['PCT_day_change'] < 5.5
        ...
        add_in_csv(regression_data, regressionResult, ws, None, None, 'downTrendSell(RISKY-DOWNTREND-BUY-1)')
        flag = True
    ...
    if('SMA9GT1' in regression_data['series_trend']
        ...
        add_in_csv(regression_data, regressionResult, ws, None, None, 'SMA9GT1Buy')
        flag = True
    if('SMA9LT-1' in regression_data['series_trend']
        and 0 < regression_data['PCT_day_change_pre1'] < 1.3
        and -1.3 < regression_data['PCT_day_change'] < 0
        ...
        add_in_csv(regression_data, regressionResult, ws, None, None, 'SMA9LT-1Sell')
        flag = True
...
def sell_oi(regression_data, regressionResult, reg, ws):
    ...
    if(regression_data['PCT_day_change'] < -2 and regression_data['PCT_change'] < -2
        ...
        if(regression_data['week2HighChange'] < 0
            ...
            elif(regression_data['PCT_day_change_pre1'] > 0 or regression_data['PCT_day_change_pre2'] > 0):
                add_in_csv(regression_data, regressionResult, ws, None, None, 'VOL:sell-UpVol-2dayDown-Week2Low')
...
def sell_supertrend(regression_data, regressionResult, reg, ws):
    ...
    if( -7.5 < regression_data['PCT_day_change_pre1'] < -1.5 and -8 < regression_data['PCT_change_pre1'] < -0.75
        ...
        and (high_tail_pct(regression_data) >= low_tail_pct(regression_data) or regression_data['high'] < regression_data['high_pre1'])
