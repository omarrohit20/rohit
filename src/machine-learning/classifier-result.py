...
def result_data(scrip):
    ...
    if((classification_data['mlpValue'] >= 0 and classification_data['kNeighboursValue'] > 0) or (classification_data['mlpValue'] > 0 and classification_data['kNeighboursValue'] >= 0)):
        ...
        if(classification_data['forecast_day_PCT7_change'] < -1 and classification_data['forecast_day_PCT10_change'] < -1 and 5 > classification_data['PCT_day_change'] > -.5 and 5 > classification_data['forecast_day_PCT_change'] > 0):
