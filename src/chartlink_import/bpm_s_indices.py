...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_11_00):
        ...
        if (sb.nw >= time_09_45 and sb.nw <= time_11_00):
            # ( {33489} ( ( {33489} ( ( ( ( [=2] 5 minute high - 1 day ago low ) * 100 ) / 1 day ago close ) > -0.3 and ( ( ( [0] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) < -1 and ( ( ( [=1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) > -4 and ( ( ( [-1] 5 minute close - [=1] 5 minute open ) * 100 ) / 1 day ago close ) < -0.75 and ( ( ( [-1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) < -1 and ( ( ( [=1] 45 minute low - [=1] 15 minute high ) * 100 ) / 1 day ago close ) > -2 and ( ( ( weekly low - 1 day ago low ) * 100 ) / 1 day ago close ) < -0.5 and ( ( ( 1 week ago low - [=1] 5 minute low ) * 100 ) / 1 day ago close ) < 0 and ( ( ( 1 week ago low - 1 day ago low ) * 100 ) / 1 day ago close ) < 0 and ( ( ( 2 days ago high - 1 day ago low ) * 100 ) / 1 day ago close ) > 1.3 and ( [=1] 15 minute high - [-1] 5 minute high ) > ( [-1] 5 minute low - [=1] 15 minute low ) and [-1] 5 minute close < [=2] 5 minute open and [-1] 5 minute close < [=2] 5 minute close and [0] 15 minute close < [=2] 5 minute open and [0] 15 minute close < [=2] 5 minute close and [=2] 15 minute high < [=-1] 5 minute high ) ) and ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 30  ) and ( ( ( [-1] 5 minute close - [-2] 5 minute open ) * 100 ) / [=1] 5 minute open ) > -0.7 and ( ( ( [-1] 5 minute close - [-3] 5 minute open ) * 100 ) / [=1] 5 minute open ) > -1 and ( ( ( [-1] 5 minute close - [-2] 5 minute open ) * 100 ) / [=1] 5 minute open ) > -0.7 and ( ( ( [-1] 5 minute close - [-3] 5 minute high ) * 100 ) / [=1] 5 minute open ) > -0.9 and ( ( ( [-1] 5 minute close - [-4] 5 minute high ) * 100 ) / [=1] 5 minute open ) > -1 ) ) ) )
