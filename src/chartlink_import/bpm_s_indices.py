...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_14_00):
        if (sb.nw >= time_09_30 and sb.nw <= time_10_00):
            ...
            process_url_volBreakout('https://chartink.com/screener/sell-morning-up-0', '9_30:checkChartSell/Buy-morningup(LastDaybeforeLT0-OR-MidacpCrossedMorningLow)', time_09_30, time_10_00)
