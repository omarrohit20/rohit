...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_12_00):
        ...
        if (sb.nw >= time_10_00 and sb.nw <= time_11_00):
            # ( {cash} ( [=1] 5 minute open < 1 day ago high and [=1] 5 minute close < 1 day ago high and [-1] 5 minute low <= [-2] 15 minute low and [-1] 5 minute low <= [-3] 15 minute low and [-1] 5 minute low < [=1] 15 minute low and ( ( [-1] 5 minute low - [=1] 5 minute low ) * 100 ) / [=1] 5 minute low < -0.3 and ( ( [-1] 5 minute close - [=-1] 5 minute close ) * 100 ) / [=-1] 5 minute close < -0.3 and ( ( [-1] 5 minute close - [=-1] 5 minute close ) * 100 ) / [=-1] 5 minute close > -2.5 and ( ( [-1] 5 minute low - [=1] 5 minute low ) * 100 ) / [=1] 5 minute low > -2.5 and ( ( 1 day ago close - 1 day ago open ) * 100 ) / 1 day ago open > -3 and ( ( 1 day ago low - 1 day ago open ) * 100 ) / 1 day ago low > -4 and ( ( 1 day ago low - 1 day ago high ) * 100 ) / 1 day ago high > -5 and ( ( [=-3] 15 minute close - 1 day ago open ) * 100 ) / 1 day ago open < -1 and ( ( 1 day ago low - [=-12] 30 minute low ) * 100 ) / [=-12] 30 minute low < -1 and ( ( [=-3] 15 minute low - 2 days ago close ) * 100 ) / 2 days ago close < -1 and ( ( [=-2] 1 hour low - 2 days ago close ) * 100 ) / 2 days ago close < -1.5 and [-1] 5 minute high < [-1] 5 minute vwap and [-2] 5 minute high < [-2] 5 minute vwap and ( ( [-2] 5 minute high - [-1] 5 minute low ) * 100 ) / [-2] 5 minute high > -0.5 and ( ( [-1] 5 minute high - [0] 5 minute low ) * 100 ) / [-1] 5 minute high > -0.5 ) )
            process_url('https://chartink.com/screener/sell-breakdown-intraday-9-30-to-10-3','(midcapdown-0.3)SSSsell-breakdown-intraday-9:40-to-10:10-01', time_10_00, time_11_00)

        if (sb.nw >= time_10_00 and sb.nw <= time_10_30):
            # ( {33489} ( ( {cash} ( ( {cash} ( ( ( [-2] 5 minute vwap - [-4] 5 minute vwap ) * 100 ) / [-4] 5 minute vwap < 0.1 and ( ( [-2] 5 minute vwap - [-4] 5 minute vwap ) * 100 ) / [-4] 5 minute vwap > -0.1 and ( ( [-2] 5 minute vwap - [-8] 5 minute vwap ) * 100 ) / [-8] 5 minute vwap > -0.1 ) ) and ( {cash} ( ( ( [-10] 1 minute vwap - [-15] 1 minute vwap ) * 100 ) / [-15] 1 minute vwap < .1 and ( ( [-10] 1 minute vwap - [-20] 1 minute vwap ) * 100 ) / [-20] 1 minute vwap < .1 and ( ( [-10] 1 minute vwap - [-15] 1 minute vwap ) * 100 ) / [-15] 1 minute vwap > -0.1 and ( ( [-10] 1 minute vwap - [-20] 1 minute vwap ) * 100 ) / [-20] 1 minute vwap > -0.1 ) ) and ( {cash} ( [=1] 5 minute close < [=1] 5 minute open and [=3] 5 minute high < [=1] 5 minute open and [0] 5 minute low < [=1] 5 minute low and [0] 5 minute low < [=2] 5 minute low and [0] 5 minute low < [=3] 5 minute low and [0] 5 minute low < [=4] 5 minute low and [=1] 30 minute high < [=-2] 15 minute high and ( ( ( [0] 5 minute low - 1 day ago close ) * 100 ) / 1 day ago close ) > -3 and ( ( ( [=1] 5 minute low - 1 day ago close ) * 100 ) / 1 day ago close ) > -3 and latest close > 100 ) ) ) ) ) )
            process_url_volBreakout('https://chartink.com/screener/morning-volume-breakout-sell-consolidation-02', 'SSSsell-morning-volume-breakout-consolidation-02(checkfirstcandledownThenup)(last2DayDownBuy)', time_10_00, time_10_30)
