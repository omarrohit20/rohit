...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_12_30): 
        ...
        if(sb.nw >= time_11_00 and sb.nw <= time_12_30):
            #( {33489} ( ( {cash} ( ( ( [-1] 5 minute vwap - [-3] 5 minute vwap ) * 100 ) / [-3] 5 minute vwap < 0.02 and ( ( [-4] 5 minute vwap - [-6] 5 minute vwap ) * 100 ) / [-6] 5 minute vwap < 0.05 and ( ( [-4] 5 minute vwap - [-9] 5 minute vwap ) * 100 ) / [-9] 5 minute vwap < 0.05 and ( ( [-4] 5 minute vwap - [-15] 5 minute vwap ) * 100 ) / [-15] 5 minute vwap < 0.05 and ( ( [-4] 5 minute vwap - [-20] 5 minute vwap ) * 100 ) / [-20] 5 minute vwap < 0.05 and ( ( [-4] 5 minute vwap - [-6] 5 minute vwap ) * 100 ) / [-6] 5 minute vwap > -0.02 and ( ( [-4] 5 minute vwap - [-9] 5 minute vwap ) * 100 ) / [-9] 5 minute vwap > -0.02 and ( ( [-4] 5 minute vwap - [-15] 5 minute vwap ) * 100 ) / [-15] 5 minute vwap > -0.02 and ( ( [-4] 5 minute vwap - [-20] 5 minute vwap ) * 100 ) / [-20] 5 minute vwap > -0.02 and abs ( ( [-4] 5 minute close - [-6] 5 minute close ) * 100 ) / [-6] 5 minute close < 0.2 and abs ( ( [-4] 5 minute close - [-6] 5 minute close ) * 100 ) / [-6] 5 minute close > -0.2 and abs ( ( [-4] 5 minute close - [-8] 5 minute close ) * 100 ) / [-8] 5 minute close < 0.2 and abs ( ( [-4] 5 minute close - [-8] 5 minute close ) * 100 ) / [-8] 5 minute close > -0.2 and abs ( ( [-4] 5 minute close - [-2] 15 minute close ) * 100 ) / [-2] 15 minute close < 0.2 and abs ( ( [-4] 5 minute close - [-2] 15 minute close ) * 100 ) / [-2] 15 minute close > -0.2 and abs ( ( [-4] 5 minute close - [-3] 15 minute close ) * 100 ) / [-3] 15 minute close < 0.2 and abs ( ( [-4] 5 minute close - [-3] 15 minute close ) * 100 ) / [-3] 15 minute close > -0.2 and ( ( [=6] 5 minute vwap - [=6] 5 minute ema ( [=6] 5 minute close , 50 ) ) * 100 ) / [=6] 5 minute ema ( [=6] 5 minute close , 50 ) > -0.3 and ( ( [=3] 5 minute vwap - [=3] 5 minute ema ( [=3] 5 minute close , 50 ) ) * 100 ) / [=3] 5 minute ema ( [=3] 5 minute close , 50 ) > -0.5 and [0] 5 minute vwap < [-2] 5 minute vwap and [-2] 5 minute vwap < [-4] 5 minute vwap and [-1] 5 minute close < [=-1] 5 minute low and [-1] 5 minute close < [=-2] 5 minute low and [-4] 5 minute close < [=-1] 5 minute low and [-4] 5 minute close < [=-2] 5 minute low and [=2] 5 minute high < [=-1] 15 minute low and [=2] 10 minute high < [=-1] 15 minute low and [=2] 15 minute high < [=-1] 15 minute low and [=2] 30 minute high < [=-1] 15 minute low and [=2] 1 hour high < [=-1] 15 minute low ) ) ) ) 
            process_url('https://chartink.com/screener/morning-volume-breakout-sell-consolidation-02', 'sell-morning-volume-breakout-consolidation-02', time_11_00, time_12_30, True)
