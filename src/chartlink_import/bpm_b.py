...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_14_00): 
        ...
        if(sb.nw>= time_11_30 and sb.nw <= time_13_30):    
            process_url('https://chartink.com/screener/sell-check-morning-up-breakdown-01', 'buy-check-morning-up', time_11_30, time_13_30)
        ...
        if(sb.nw>= time_10_00 and sb.nw <= time_11_00):
            process_url('https://chartink.com/screener/buy-dayconsolidation-breakout-02', 'buy-vol-dayconsol-wait', time_10_00, time_11_00, True)
