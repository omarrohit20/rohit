...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_13_30):             
        ...
        if(sb.nw>= time_10_25 and sb.nw <= time_11_00):
            #( {33489} ( ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 24  ) and [=1] 15 minute volume > greatest(  1 day ago volume / 18  ) and [=1] 5 minute volume > greatest(  2 days ago volume / 24  ) and ( ( [=1] 5 minute high - [=1] 5 minute close ) * 100 ) / [=1] 5 minute close < 1 and [=1] 5 minute close > [=1] 5 minute open and [=1] 5 minute close > 1 day ago close ) ) and ( {cash} ( [=1] 5 minute close > [=-1] 5 minute high and abs ( ( ( [=1] 5 minute close - [=1] 5 minute open ) * 100 ) / [=1] 5 minute open ) > 0.1 ) ) and ( {cash} ( ( ( [-1] 5 minute close - [0] 1 hour low ) * 100 ) / [-1] 5 minute close < 0.75 and ( ( [-1] 5 minute close - 1 day ago close ) * 100 ) / [-1] 5 minute close < 2 and [0] 5 minute high < [-1] 5 minute high and [0] 5 minute high < [-2] 5 minute high and [0] 5 minute high < [-3] 5 minute high and [0] 5 minute high < [0] 5 minute vwap ) ) ) ) 
            process_url_volBreakout('https://chartink.com/screener/sell-morning-up-0', 'sell-morning-up-breakdown-VWAP-0-10:30', time_10_25, time_11_00)

        if(sb.nw>= time_10_00 and sb.nw <= time_11_30):
            #( {cash} ( [=1] 15 minute "close - 1 candle ago close / 1 candle ago close * 100" > 1.5 and [=1] 30 minute "close - 1 candle ago close / 1 candle ago close * 100" > 1.5 and [-1] 5 minute low > [-1] 5 minute ema ( [0] 5 minute close , 50 ) and [-2] 5 minute low > [-2] 5 minute ema ( [0] 5 minute close , 50 ) and [-3] 5 minute low > [-3] 5 minute ema ( [0] 5 minute close , 50 ) and [-4] 5 minute low > [-4] 5 minute ema ( [0] 5 minute close , 50 ) and [-5] 5 minute low > [-5] 5 minute ema ( [0] 5 minute close , 50 ) and [-1] 5 minute high < [-1] 5 minute vwap and [-2] 5 minute close < [-2] 5 minute vwap and [-3] 5 minute close < [-3] 5 minute vwap and [-4] 5 minute close < [-4] 5 minute vwap and [-6] 5 minute close > [-6] 5 minute vwap and [-7] 5 minute close > [-7] 5 minute vwap and [-8] 5 minute close > [-8] 5 minute vwap and [-1] 5 minute close < [-1] 5 minute vwap and [=1] 30 minute low = [=1] 1 hour low and [=2] 30 minute low > [=1] 30 minute low and [=1] 1 hour high = [=1] 15 minute high and ( ( ( [=1] 30 minute low - [=2] 30 minute low ) * 100 ) / [=2] 30 minute low ) < -0.5 and ( ( ( [-1] 5 minute low - [-5] 5 minute low ) * 100 ) / [-5] 5 minute low ) > -1 and ( ( ( [-1] 5 minute low - [-4] 5 minute low ) * 100 ) / [-4] 5 minute low ) < -0.1 ) ) 
            process_url_volBreakout('https://chartink.com/screener/sell-morning-up-1', 'checkchart-breakdown-VWAP-10', time_10_00, time_11_30)
