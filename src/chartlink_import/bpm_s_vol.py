...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_23_00):             
        if(sb.nw>= time_09_20 and sb.nw <= time_23_00):    
            process_url_volBreakout('https://chartink.com/screener/morning-volume-breakout-sell-1', 'morning-volume-breakout-sell', time_09_15, time_23_00)
            process_url_volBreakout('https://chartink.com/screener/morning-volume-breakout-sell-2', 'morning-volume-breakout-sell', time_09_15, time_23_00)
