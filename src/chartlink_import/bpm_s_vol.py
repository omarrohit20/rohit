...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_11_15):
        ...
        if (sb.nw >= time_10_00 and sb.nw <= time_12_00):
            # ( {33489} ( ( {cash} ( ( ( ( [-1] 5 minute low - 1 day ago low ) * 100 ) / 1 day ago close ) < 0.5 and ( ( ( [-1] 5 minute low - 2 days ago low ) * 100 ) / 1 day ago close ) < 0.5 and ( ( ( [=1] 30 minute low - 1 day ago open ) * 100 ) / 1 day ago close ) > -3 and ( ( ( [-1] 5 minute low - 2 days ago close ) * 100 ) / 1 day ago close ) > -3 and ( ( ( [-1] 5 minute low - [=1] 5 minute open ) * 100 ) / 1 day ago close ) > -2 and ( ( ( [-1] 5 minute close - [=1] 10 minute low ) * 100 ) / 1 day ago close ) < 0 and ( ( ( [-1] 5 minute close - [=1] 5 minute open ) * 100 ) / 1 day ago close ) < -0.7 and ( ( ( [-1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) < -1.3 and ( ( ( [=1] 15 minute low - 1 day ago close ) * 100 ) / 1 day ago close ) > -1.3 and ( ( ( 1 day ago low - 1 day ago close ) * 100 ) / 1 day ago close ) > -1.5 and ( ( ( 1 day ago close - 1 day ago open ) * 100 ) / 1 day ago close ) > -2 and ( ( ( [=1] 1 hour high - 1 day ago close ) * 100 ) / 1 day ago close ) < 0.5 and ( ( ( [=1] 1 hour low - [-1] 15 minute low ) * 100 ) / 1 day ago close ) > -0.5 and 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" < 2 and [-1] 5 minute close < [=1] 10 minute low and ( ( ( [-1] 5 minute close - [-2] 5 minute open ) * 100 ) / [=1] 5 minute open ) > -0.7 and ( ( ( [-1] 5 minute close - [-3] 5 minute low ) * 100 ) / [=1] 5 minute open ) > -0.9 ) ) ) )
