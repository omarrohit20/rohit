...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_10_30):
        ...
        if(sb.nw>= time_09_30 and sb.nw <= time_11_30):
            # ( {33489} ( ( {cash} ( ( ( ( [=2] 5 minute high - [=1] 5 minute open ) * 100 ) / [=1] 5 minute low ) > 0.75 and ( ( ( [=1] 20 minute high - [=1] 5 minute low ) * 100 ) / [=1] 5 minute low ) > 2 and ( ( ( [=3] 5 minute high - [-1] 5 minute low ) * 100 ) / [-1] 5 minute low ) > 0.75 and [=1] 5 minute close > [=1] 5 minute open and [=1] 30 minute high > 1 day ago close and [-1] 5 minute close < [=2] 5 minute high and [-1] 5 minute vwap < [-2] 5 minute vwap and ( ( [-1] 5 minute vwap - [=1] 5 minute vwap ) * 100 ) / [=1] 5 minute vwap < 0.3 ) ) ) )
        ...
        if(sb.nw>= time_09_30 and sb.nw <= time_10_15):
            # ( {33489} ( ( {cash} ( ( ( ( [=1] 15 minute high - 1 day ago close ) * 100 ) / 1 day ago close ) > 2 and [=1] 30 minute high > 1 day ago close and [-1] 5 minute close > 1 day ago close and [-1] 5 minute close < [=1] 5 minute close and [-1] 5 minute vwap < [-3] 5 minute vwap and ( ( [-1] 5 minute vwap - [=1] 5 minute vwap ) * 100 ) / [=1] 5 minute vwap < -0.5 ) ) ) )
