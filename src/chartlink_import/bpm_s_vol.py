...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_11_00):
        ...
        if (sb.nw >= time_09_30 and sb.nw <= time_10_00):
            ...
            process_url_volBreakout('https://chartink.com/screener/sell-morning-volume-breakout-checknews-01', 'sell-morning-volume-breakout(Check-News)-01', time_09_25, time_10_00)

        if(sb.nw>= time_09_25 and sb.nw <= time_09_45):
            #( {33489} ( ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 24  ) and latest "close - 1 candle ago close / 1 candle ago close * 100" < 0.5 and 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" < -1 and 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" > -3 and ( ( ( 1 day ago close - 1 day ago open ) * 100 ) / 1 day ago close ) < -1 and [=2] 10 minute high > [=-2] 30 minute low ) ) ) )
            process_url_volBreakout('https://chartink.com/screener/morning-volume-breakout-sell-3', 'SSSsell-downtrend-breakout-morning-volume', time_09_00, time_09_30, 'breakout-morning-volume-sell')
