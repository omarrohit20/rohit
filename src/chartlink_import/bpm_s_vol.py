...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_10_30):
        ...
        if (sb.nw >= time_09_40 and sb.nw <= time_10_30):
            # ( {57960} ( ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 24  ) and [=1] 15 minute volume > greatest(  1 day ago volume / 18  ) and [=1] 5 minute volume > greatest(  2 days ago volume / 24  ) and [=1] 5 minute low < [=1] 5 minute sma ( [=1] 5 minute close , 200 ) and [=1] 5 minute close < [=1] 5 minute open and [=1] 5 minute close < 1 day ago close and ( ( ( [=2] 5 minute high - 1 day ago close ) * 100 ) / 1 day ago close ) < -0.5 and ( ( ( [=1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) < -0.5 and ( ( ( [=1] 5 minute close - [=1] 5 minute open ) * 100 ) / 1 day ago close ) < -0.1 and ( {cash} ( [=3] 5 minute low < [=1] 5 minute close and [=2] 5 minute low < [=1] 5 minute low and [-1] 5 minute low < [=3] 5 minute close and [-1] 5 minute low < [=3] 5 minute open and [-1] 5 minute low < [=1] 5 minute open and [-1] 5 minute low < [=1] 5 minute close and [-1] 5 minute high < [-1] 5 minute vwap and 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" > -2 ) ) ) ) ) )
            process_url('https://chartink.com/screener/sell-morning-volume-breakout-after10', 'sell-morning-down-volume-breakout', time_09_40, time_10_30)
