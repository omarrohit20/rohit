...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_12_00):
        if (sb.nw >= time_09_45 and sb.nw <= time_12_00):
            #( {cash} ( ( {33489} ( [0] 5 minute high > [=-1] 3 hour high and [0] 5 minute high > [=2] 10 minute high and [0] 5 minute high > [=2] 15 minute high and [0] 5 minute high > [=3] 15 minute high and [=1] 30 minute high = [=1] 15 minute high and [=2] 15 minute low < [=1] 5 minute open and ( ( ( [=1] 5 minute open - [=1] 30 minute low ) * 100 ) / 1 day ago close ) < 1.5 and ( ( ( [=1] 5 minute close - [=1] 30 minute low ) * 100 ) / 1 day ago close ) < 1.5 and ( ( ( 1 day ago close - [=1] 30 minute low ) * 100 ) / 1 day ago close ) < 1.5 ) ) and ( {cash} ( [=1] 30 minute low < 2 days ago high and [=1] 5 minute volume > greatest(  1 day ago volume / 24  ) and [=1] 15 minute volume > greatest(  1 day ago volume / 18  ) and abs ( 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" ) < 1.5 and abs ( [=1] 5 minute "close - 1 candle ago close / 1 candle ago close * 100" ) > 0.5 ) ) ) )
        ...
        if (sb.nw >= time_09_45 and sb.nw <= time_12_00):
            #( {cash} ( ( {33489} ( [0] 5 minute high > [=-1] 3 hour high and [0] 5 minute high > [=2] 10 minute high and [0] 5 minute high > [=2] 15 minute high and [0] 5 minute high > [=3] 15 minute high and [=1] 30 minute high = [=1] 15 minute high and [=2] 15 minute low < [=1] 5 minute open and ( ( ( [=1] 5 minute open - [=1] 30 minute low ) * 100 ) / 1 day ago close ) < 1.5 and ( ( ( [=1] 5 minute close - [=1] 30 minute low ) * 100 ) / 1 day ago close ) < 1.5 and ( ( ( 1 day ago close - [=1] 30 minute low ) * 100 ) / 1 day ago close ) < 1.5 ) ) and ( {cash} ( [-2] 15 minute "close - 1 candle ago close / 1 candle ago close * 100" > 0.1 and [-1] 15 minute "close - 1 candle ago close / 1 candle ago close * 100" > 0.3 and [=1] 5 minute low > [=-1] 15 minute high and ( ( ( [-1] 15 minute high - [=1] 5 minute high ) * 100 ) / 1 day ago close ) < 1 and ( 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" ) < 3 ) ) ) )
        ...
        if (sb.nw >= time_09_40 and sb.nw <= time_11_00):
            ...
            process_url_volBreakout('https://chartink.com/screener/buy-breakup-intraday-9-25-to-10-30-06', '1-Bbuyy-morningUp-downConsolidation', time_09_40, time_11_00)
        """
