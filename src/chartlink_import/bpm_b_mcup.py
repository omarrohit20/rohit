...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_11_00):
        if (sb.nw >= time_09_40 and sb.nw <= time_11_30):
            # ( {cash} ( ( {cash} ( abs ( [-1] 5 minute close - [-1] 5 minute sma ( [-1] 5 minute close , 200 ) * 100 ) / [-1] 5 minute close > 3.5 and abs ( [=-1] 5 minute close - [=-1] 5 minute sma ( [=-1] 5 minute close , 200 ) * 100 ) / [-1] 5 minute close < 2 and [=-5] 2 hour high >= 2 days ago "( (1 candle ago high + 1 candle ago low + 1 candle ago close / 3 ) * 2 - 1 candle ago low )" and abs ( [-1] 5 minute close - [0] 5 minute open * 100 ) / [-1] 5 minute close < 2 and abs ( [-1] 5 minute close - [-2] 5 minute open * 100 ) / [-1] 5 minute close < 2 and abs ( [-1] 5 minute close - [-1] 5 minute open * 100 ) / [-1] 5 minute close < 1 and [-1] 5 minute volume > [=1] 5 minute volume and [-1] 5 minute volume > [=2] 5 minute volume and [-1] 5 minute volume > [=3] 5 minute volume and ( ( ( [-1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) > 1 and [0] 5 minute close > 50 and [0] 5 minute close < 3000 and market cap > 1000 ) ) ) )
            process_url_volBreakout('https://chartink.com/screener/buy-ema-up0', 'buy-sma200-up', time_09_40, time_11_30)
        ...
        if (sb.nw >= time_09_40 and sb.nw <= time_10_00):
            ...
            process_url_volBreakout('https://chartink.com/screener/buy-breakup-intraday-9-25-to-10-30-06', 'buy-morningUp-downConsolidation)', time_09_40, time_10_00)

        if(sb.nw>= time_09_20 and sb.nw <= time_10_00):
            #( {33489} ( ( {cash} ( [0] 5 minute high > [=2] 5 minute high and [-1] 5 minute high > 1 day ago high and [-1] 5 minute high > 2 days ago high and [-3] 5 minute low < 1 day ago high and [-3] 5 minute low < 2 days ago high and [-3] 5 minute low < 3 days ago high and 1 day ago low < 4 days ago high and 1 day ago low < 5 days ago high and 1 day ago low < 6 days ago high and abs ( 1 day ago close - 10 days ago open ) * 100 / 1 day ago close > 3 and abs ( 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" ) < 1 and abs ( 1 day ago close - 1 day ago open * 100 ) / 1 day ago close < 1.3 and abs ( 2 days ago close - 2 days ago open * 100 ) / 2 days ago close < 1.3 and ( 1 day ago close - [0] 5 minute high * 100 ) / 1 day ago close > -1.5 and ( 1 day ago low - [0] 5 minute high * 100 ) / 1 day ago close > -2.5 ) ) ) )
            process_url('https://chartink.com/screener/supertrend-morning-buy', 'buy-consolidation-3day', time_09_20, time_10_00)
