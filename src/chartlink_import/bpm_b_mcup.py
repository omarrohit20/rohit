...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_12_00):
        if (sb.nw >= time_09_45 and sb.nw <= time_11_00):
            # ( {46553} ( ( {cash} ( [0] 5 minute high > [=-1] 3 hour high and [0] 5 minute high > [=2] 10 minute high and [0] 5 minute high > [=2] 15 minute high and [0] 5 minute high > [=3] 15 minute high and [=1] 25 minute high = [=1] 15 minute high and [=2] 15 minute low < [=1] 5 minute open and ( ( ( [=1] 5 minute open - [=1] 30 minute low ) * 100 ) / 1 day ago close ) < 1.5 and ( ( ( [=1] 5 minute close - [=1] 30 minute low ) * 100 ) / 1 day ago close ) < 1.5 and ( ( ( [-1] 5 minute close - 1 day ago high ) * 100 ) / 1 day ago close ) > -0.5 and ( ( ( 1 day ago close - [=1] 30 minute low ) * 100 ) / 1 day ago close ) < 1.5 and ( ( ( [=1] 5 minute high - [=1] 5 minute low ) * 100 ) / 1 day ago close ) < 1.3 and ( ( ( [-1] 5 minute high - [=1] 5 minute low ) * 100 ) / 1 day ago close ) < 2.5 and ( ( ( [-1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) > 1.2 and ( ( ( [-1] 5 minute high - [-4] 5 minute close ) * 100 ) / 1 day ago close ) > 0 and ( ( ( [-1] 5 minute close - [-2] 15 minute low ) * 100 ) / 1 day ago close ) < 1.5 and ( ( ( [-1] 5 minute close - [=2] 15 minute low ) * 100 ) / 1 day ago close ) < 2 ) ) and ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 24  ) and [=1] 15 minute volume > greatest(  1 day ago volume / 18  ) and abs ( 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" ) < 1.5 and abs ( [=1] 5 minute "close - 1 candle ago close / 1 candle ago close * 100" ) > 0.3 and ( [=2] 5 minute "close - 1 candle ago close / 1 candle ago close * 100" ) < 0.5 and [0] 5 minute close > [0] 5 minute open and [0] 5 minute volume > [-1] 5 minute volume ) ) ) )
