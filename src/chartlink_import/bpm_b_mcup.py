...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_11_00):
        ...
        if (sb.nw >= time_09_40 and sb.nw <= time_10_00):
            # ( {33489} ( ( {cash} ( ( ( ( [=1] 15 minute high - 1 day ago close ) * 100 ) / 1 day ago close ) > 0.75 and [=1] 30 minute high > 1 day ago close and [=1] 30 minute high = [=1] 20 minute high and [-1] 5 minute vwap < [-3] 5 minute vwap and [=1] 5 minute close > [=1] 5 minute open and [=2] 5 minute close > [=1] 5 minute open and [=2] 5 minute open > [=1] 5 minute open and ( ( ( [=1] 5 minute close - [=1] 5 minute open ) * 100 ) / 1 day ago close ) > 0.5 and ( ( ( [-1] 5 minute close - [=-1] 5 minute high ) * 100 ) / 1 day ago close ) > 1.2 ) ) and ( {cash} ( [=1] 3 minute volume > greatest(  1 day ago volume / 24  ) and ( ( ( [=1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) > 1 and ( ( ( 1 day ago close - 2 days ago close ) * 100 ) / 2 days ago close ) < 1 and [0] 15 minute "close - 1 candle ago close / 1 candle ago close * 100" > 0 ) ) ) )
            process_url_volBreakout('https://chartink.com/screener/buy-breakup-intraday-9-25-to-10-30-06', '0-Bbuyy-morningUp-downConsolidation', time_09_40, time_10_00)
        ...
        if (sb.nw >= time_10_00 and sb.nw <= time_10_30):
            ...
            process_url_volBreakout('https://chartink.com/screener/buy-dayconsolidation-breakout-02', '1-Bbuyy-morningUp-downConsolidation', time_09_45, time_10_45)
        ...
        if (sb.nw >= time_09_40 and sb.nw <= time_10_15):
            ...
            process_url('https://chartink.com/screener/buy-morning-down-1', '1-Bbuyy-checkChart-ema-up1(buy-above-cons-R2:followLastDayPostlunch-lt-R1R2)', time_09_40, time_10_00)
