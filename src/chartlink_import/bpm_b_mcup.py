...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_11_00):
        ...
        if (sb.nw >= time_09_40 and sb.nw <= time_10_30):
            ...
            process_url('https://chartink.com/screener/morning-volume-breakout-1-2', 'BBBbuy-morning-up-volume-breakout', time_09_45, time_10_15)
        ...
        if (sb.nw >= time_09_40 and sb.nw <= time_10_00):
            ...
            process_url('https://chartink.com/screener/buy-breakup-intraday-9-25-to-10-30-06', 'BBBbuy-morningUp-downConsolidation', time_09_40, time_10_00)
        ...
        if (sb.nw >= time_09_20 and sb.nw <= time_10_30):
            ...
            process_url('https://chartink.com/screener/buy-downtrend-01', 'downlast3day: BBBbuy-lastDayDoji/buy-first10minuteHigh-below-2-day-ago-close/SELL-first10minuteHigh-gt-2day-ago-close/)', time_09_25, time_10_30)
