...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_11_00):
        ...
        if (sb.nw >= time_09_30 and sb.nw <= time_10_00):
            # ( {33489} ( ( {cash} ( ( ( ( [=1] 15 minute low - 1 day ago close ) * 100 ) / 1 day ago close ) < -0.75 and [=1] 30 minute low < 1 day ago close and [=1] 30 minute low = [=1] 20 minute low and [-1] 5 minute vwap > [-3] 5 minute vwap and [=1] 5 minute close < [=1] 5 minute open and [=2] 5 minute open < [=1] 5 minute open and [=2] 5 minute close < [=1] 5 minute open and ( ( ( [=1] 5 minute close - [=1] 5 minute open ) * 100 ) / 1 day ago close ) < -0.5 and ( ( ( [-1] 5 minute close - [=-1] 5 minute low ) * 100 ) / 1 day ago close ) < -1.2 ) ) and ( {cash} ( [=1] 3 minute volume > greatest(  1 day ago volume / 24  ) and ( ( ( [=1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) < -1 and ( ( ( 1 day ago close - 2 days ago close ) * 100 ) / 2 days ago close ) > -1 and [0] 15 minute "close - 1 candle ago close / 1 candle ago close * 100" < 0 ) ) ) )
            process_url_volBreakout('https://chartink.com/screener/sell-breakdown-intraday-9-50-to-10-10-04', '0-Sselll-morningDown-upConsolidation', time_09_30, time_10_00)

        if (sb.nw >= time_10_00 and sb.nw <= time_10_30):
            #( {33489} ( ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 24  ) and ( ( ( [-1] 5 minute close - [=-1] 5 minute close ) * 100 ) / [=-1] 5 minute close ) < -1.1 and ( ( ( [-1] 5 minute close - [=1] 5 minute high ) * 100 ) / [=1] 5 minute open ) > -2 and ( ( ( [-1] 5 minute close - [=1] 5 minute high ) * 100 ) / [=1] 5 minute open ) < -0.75 and ( ( ( [=1] 30 minute low - [-1] 5 minute close ) * 100 ) / [-1] 5 minute close ) > -0.5 and ( ( ( 1 day ago close - 3 days ago close ) * 100 ) / 1 day ago close ) > -6 and ( ( ( 1 day ago close - 2 days ago close ) * 100 ) / 2 days ago close ) > -3 and [0] 30 minute "close - 1 candle ago close / 1 candle ago close * 100" < 0 and [0] 15 minute "close - 1 candle ago close / 1 candle ago close * 100" < 0.3 and [0] 5 minute low > [=1] 30 minute low and [=1] 15 minute high > 1 day ago low and [=2] 15 minute high < [=-1] 15 minute low ) ) ) )
            process_url_volBreakout('https://chartink.com/screener/sell-dayconsolidation-breakout-02', '1-Sselll-morningDown-upConsolidation', time_09_45, time_10_45)
        ...
        if (sb.nw >= time_09_40 and sb.nw <= time_10_15):
            ...
            process_url('https://chartink.com/screener/sell-morning-up-1', '1-Sselll-checkChart-ema-down(sell-bellow-cons-S2:followLastDayPostlunch-gt-S1S2)', time_09_40, time_10_00)
