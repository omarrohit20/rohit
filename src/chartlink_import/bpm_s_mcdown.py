...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_11_00):
        ...
        if (sb.nw >= time_09_40 and sb.nw <= time_10_30):
            ...
            process_url('https://chartink.com/screener/sell-morning-volume-breakout-after10', '0-sell-morning-down-volume-breakout', time_09_40, time_10_30)
        ...
        if (sb.nw >= time_09_30 and sb.nw <= time_10_30):
            ...
            process_url('https://chartink.com/screener/sell-dayconsolidation-breakout-04', '1-sell-morning-down-volume-breakout', time_09_30, time_10_15)
        ...
        if (sb.nw >= time_09_30 and sb.nw <= time_10_00):
            ...
            process_url('https://chartink.com/screener/sell-breakdown-intraday-9-50-to-10-10-04', 'Sell-morningDown-upConsolidation', time_09_30, time_10_00)
