...
if __name__ == "__main__":
    ...
    while (sb.sb.nw <= time_14_30):
        if(sb.sb.nw>= time_09_20 and sb.sb.nw <= time_10_30):
        ...
        if(sb.sb.nw>= time_09_40 and sb.sb.nw <= time_10_30):  
        ...
        if(sb.sb.nw>= time_12_00 and sb.sb.nw <= time_14_30): 
