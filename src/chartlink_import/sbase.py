                    ...
                    if(needToPrint == True):
                        ...
                        if((db[processor].find_one({'scrip':tempScrip}) is None) and tempScrip != ''):
                            ...
                            if ('09_30:checkChartBuy/Sell-morningDown' in processor
                                ...
                                and ((float(db['morning-volume-breakout-buy'].find_one({'scrip':tempScrip})['PCT_day_change']) < 1.5)
                                     or (float(db['morning-volume-breakout-buy'].find_one({'scrip':tempScrip})['PCT_day_change_pre1']) < 1.5)
                                    )
                            ...
                            if ('09_30:checkChartSell/Buy-morningup' in processor
                                ...
                                and ((float(db['morning-volume-breakout-sell'].find_one({'scrip':tempScrip})['PCT_day_change']) > -1.5)
                                     or (float(db['morning-volume-breakout-sell'].find_one({'scrip':tempScrip})['PCT_day_change_pre1']) > 1.5)
                                    )
