...
if __name__ == "__main__":
    ...
    with sync_playwright() as p:
        ...
        if (sb.nw >= time_00_15 and sb.nw <= time_24_00):
            ...
            # #
            # #
            process_url_volBreakout('https://chartink.com/screener/cash-buy-202616', 'cash-buuy', time_09_20, time_12_00, dropDB=True)

            process_url_volBreakout('https://chartink.com/screener/cash-sell-404117', 'cash-seell', time_09_20, time_12_00, dropDB=True)
