    ...
    with sync_playwright() as p:
        ...
        if (sb.nw >= time_00_15 and sb.nw <= time_24_00):
            ...
            process_url_volBreakout('https://chartink.com/screener/buy-morning-volume-breakout-checknews',
                                        'buy-morning-volume-breakout(Check-News)', time_09_40, time_12_30)
            ...
            process_url_volBreakout('https://chartink.com/screener/sell-morning-volume-breakout-checknews',
                                        'sell-morning-volume-breakout(Check-News)', time_09_40, time_12_30)
