...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_13_30):        
        if(sb.nw>= time_09_15 and sb.nw <= time_10_00): 
            process_url('https://chartink.com/screener/03-buybreakupintraday-01', '(==Reversal==)03-buyBreakupIntraday', time_09_15, time_10_00)
        ...
        if(sb.nw>= time_10_00 and sb.nw <= time_13_30):
            process_url('https://chartink.com/screener/morning-volume-breakout-buy-consolidation-01', 'morning-volume-breakout-buy-consolidation', time_10_00, time_13_30)
         
        if(sb.nw>= time_10_00 and sb.nw <= time_13_30):
            process_url('https://chartink.com/screener/morning-volume-breakout-buy-consolidation-02', 'morning-volume-breakout-buy-consolidation', time_10_00, time_13_30)
