...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_12_00):
        ...
        if (sb.nw >= time_09_35 and sb.nw <= time_10_00):
            # ( {cash} ( [=1] 5 minute open > 1 day ago low and [=1] 5 minute close > 1 day ago low and [-1] 5 minute high >= [-2] 15 minute high and [-1] 5 minute high >= [-3] 15 minute high and [-1] 5 minute high > [=1] 15 minute high and ( ( [-1] 5 minute high - [=1] 5 minute high ) * 100 ) / [=1] 5 minute high > 0.3 and ( ( [-1] 5 minute close - [=-1] 5 minute close ) * 100 ) / [=-1] 5 minute close > 0.3 and ( ( [-1] 5 minute close - [=-1] 5 minute close ) * 100 ) / [=-1] 5 minute close < 2.5 and ( ( [-1] 5 minute high - [=1] 5 minute high ) * 100 ) / [=1] 5 minute high < 2.5 and ( ( 1 day ago close - 1 day ago open ) * 100 ) / 1 day ago open < 3 and ( ( 1 day ago high - 1 day ago open ) * 100 ) / 1 day ago high < 4 and ( ( 1 day ago high - 1 day ago low ) * 100 ) / 1 day ago low < 5 and ( ( [=-3] 15 minute close - 1 day ago open ) * 100 ) / 1 day ago open > 1 and ( ( [=-1] 15 minute high - [=-13] 30 minute high ) * 100 ) / [=-13] 30 minute high > 0.5 and ( ( [=-1] 15 minute high - [=-12] 30 minute high ) * 100 ) / [=-12] 30 minute high > 0 and ( ( 1 day ago high - [=-12] 30 minute high ) * 100 ) / [=-12] 30 minute high > 1 and ( ( [=-3] 15 minute high - 2 days ago close ) * 100 ) / 2 days ago close > 1 and ( ( [=-2] 1 hour high - 2 days ago close ) * 100 ) / 2 days ago close > 1.5 and [-1] 5 minute low > [-1] 5 minute vwap and [-2] 5 minute low > [-2] 5 minute vwap and ( ( [-2] 5 minute high - [-1] 5 minute low ) * 100 ) / [-2] 5 minute high < 0.5 and ( ( [-1] 5 minute high - [0] 5 minute low ) * 100 ) / [-1] 5 minute high < 0.5 ) )
            process_url('https://chartink.com/screener/buy-breakup-intraday-9-30-to-10', '(midcapup0.3)BBBbuy-breakup-intraday-9:40-to-10:10', time_09_35, time_10_00, True)
            # ( {cash} ( [=1] 5 minute open > 1 day ago low and [=1] 5 minute close > 1 day ago low and [-1] 5 minute high >= [-2] 15 minute high and [-1] 5 minute high > [=1] 15 minute high and ( ( [-1] 5 minute close - [=-1] 5 minute close ) * 100 ) / [=-1] 5 minute close < 2.5 and ( ( [-1] 5 minute high - [=1] 5 minute high ) * 100 ) / [=1] 5 minute high < 2.5 and ( ( 1 day ago close - 1 day ago open ) * 100 ) / 1 day ago open < 2 and ( ( 1 day ago close - 2 days ago open ) * 100 ) / 2 days ago open < 3 and ( ( 1 day ago close - 3 days ago close ) * 100 ) / 3 days ago close < 3 and ( ( 1 day ago high - 1 day ago open ) * 100 ) / 1 day ago high < 4 and ( ( 1 day ago high - 1 day ago low ) * 100 ) / 1 day ago low < 5 and ( ( [=-3] 15 minute close - 1 day ago open ) * 100 ) / 1 day ago open > 1 and ( ( 1 day ago high - [=-12] 30 minute high ) * 100 ) / [=-12] 30 minute high > 1 and ( ( [=-3] 15 minute high - 2 days ago close ) * 100 ) / 2 days ago close > 1 and ( ( [=-2] 1 hour high - 2 days ago close ) * 100 ) / 2 days ago close > 1.5 and [0] 5 minute high > 1 day ago high and [-1] 5 minute low > [-1] 5 minute vwap and [-2] 5 minute low > [-2] 5 minute vwap and ( ( [-2] 5 minute high - [-1] 5 minute low ) * 100 ) / [-2] 5 minute high < 0.5 and ( ( [-1] 5 minute high - [0] 5 minute low ) * 100 ) / [-1] 5 minute high < 0.5 ) )
            process_url('https://chartink.com/screener/buy-breakup-intraday-9-50-to-10-10-01', '(midcapup0.3)BBBbuy-breakup-intraday-9:40-to-10:10', time_09_35, time_10_00, True)

        if (sb.nw >= time_10_00 and sb.nw <= time_11_00):
            # ( {cash} ( [=1] 5 minute open > 1 day ago low and [=1] 5 minute close > 1 day ago low and [-1] 5 minute high >= [-2] 15 minute high and [-1] 5 minute high >= [-3] 15 minute high and [-1] 5 minute high > [=1] 15 minute high and ( ( [-1] 5 minute high - [=1] 5 minute high ) * 100 ) / [=1] 5 minute high > 0.3 and ( ( [-1] 5 minute close - [=-1] 5 minute close ) * 100 ) / [=-1] 5 minute close > 0.3 and ( ( [-1] 5 minute close - [=-1] 5 minute close ) * 100 ) / [=-1] 5 minute close < 2.5 and ( ( [-1] 5 minute high - [=1] 5 minute high ) * 100 ) / [=1] 5 minute high < 2.5 and ( ( 1 day ago close - 1 day ago open ) * 100 ) / 1 day ago open < 3 and ( ( 1 day ago high - 1 day ago open ) * 100 ) / 1 day ago high < 4 and ( ( 1 day ago high - 1 day ago low ) * 100 ) / 1 day ago low < 5 and ( ( [=-3] 15 minute close - 1 day ago open ) * 100 ) / 1 day ago open > 1 and ( ( [=-1] 15 minute high - [=-13] 30 minute high ) * 100 ) / [=-13] 30 minute high > 0.5 and ( ( [=-1] 15 minute high - [=-12] 30 minute high ) * 100 ) / [=-12] 30 minute high > 0 and ( ( 1 day ago high - [=-12] 30 minute high ) * 100 ) / [=-12] 30 minute high > 1 and ( ( [=-3] 15 minute high - 2 days ago close ) * 100 ) / 2 days ago close > 1 and ( ( [=-2] 1 hour high - 2 days ago close ) * 100 ) / 2 days ago close > 1.5 and [-1] 5 minute low > [-1] 5 minute vwap and [-2] 5 minute low > [-2] 5 minute vwap and ( ( [-2] 5 minute high - [-1] 5 minute low ) * 100 ) / [-2] 5 minute high < 0.5 and ( ( [-1] 5 minute high - [0] 5 minute low ) * 100 ) / [-1] 5 minute high < 0.5 ) )
            process_url('https://chartink.com/screener/buy-breakup-intraday-9-30-to-10', '(midcapup0.3)BBBbuy-breakup-intraday-9:40-to-10:10', time_10_00, time_11_00)
