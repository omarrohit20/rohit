...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_14_00):
        ...
        if (sb.nw >= time_09_30 and sb.nw <= time_14_00):
            ...
            process_url_volBreakout('https://chartink.com/screener/morning-volume-breakout-buy-2', '$$$$$$$$$Buy-SellDayTrend-volume-breakout-5minutes', time_09_40, time_14_00)
        ...
        if(sb.nw >= time_09_30 and sb.nw <= time_11_00):
            ...
            process_url_volBreakout('https://chartink.com/screener/buy-dayconsolidation-breakout-04', '$$$$$$$$$Buy-SellDayTrendbuy-dayconsolidation', time_10_00, time_11_30)
