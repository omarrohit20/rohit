...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_14_00):
        ...
        if (sb.nw >= time_09_45 and sb.nw <= time_11_00):
            ...
            process_url_volBreakout('https://chartink.com/screener/buy-morning-volume-breakout-checknews', 'buy-morning-volume-breakout(Check-News)', time_09_45, time_10_50)
