...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_10_30):
        if (sb.nw >= time_09_25 and sb.nw <= time_09_45):
            # ( {46553} ( ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 12  ) and [=1] 15 minute volume > greatest(  1 day ago volume / 18  ) and [=1] 5 minute volume > greatest(  2 days ago volume / 24  ) and [=1] 5 minute high > [=1] 5 minute sma ( [=1] 5 minute close , 200 ) and [=1] 5 minute close > [=1] 5 minute open and [=1] 5 minute close > 1 day ago close and ( ( ( [=2] 5 minute low - 1 day ago close ) * 100 ) / 1 day ago close ) > 0.5 and ( ( ( [-1] 5 minute high - 1 day ago close ) * 100 ) / 1 day ago close ) < 1.5 and ( ( ( [-1] 5 minute high - 1 day ago close ) * 100 ) / 1 day ago close ) > 1 and ( ( ( [-1] 5 minute high - 2 days ago open ) * 100 ) / 2 days ago open ) < 4 and [0] 5 minute high > [=3] 5 minute close and [0] 5 minute high > [=3] 5 minute open and 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" < 1.75 and 1 day ago close > 2 days ago open and 1 day ago close > 3 days ago close ) ) ) )
            process_url('https://chartink.com/screener/buy-morning-volume-breakout-checknews-01', 'buy-morning-volume-breakout(Check-News)-01', time_09_25, time_09_45)
        ...
        if(sb.nw >= time_09_45 and sb.nw <= time_10_30):
            # ( {33489} ( ( {cash} ( ( {cash} ( ( ( [-2] 5 minute vwap - [-4] 5 minute vwap ) * 100 ) / [-4] 5 minute vwap < 0.1 and ( ( [-2] 5 minute vwap - [-8] 5 minute vwap ) * 100 ) / [-8] 5 minute vwap < 0.1 and ( ( [-2] 5 minute vwap - [-4] 5 minute vwap ) * 100 ) / [-4] 5 minute vwap > -0.1 ) ) and ( {cash} ( ( ( [-10] 1 minute vwap - [-15] 1 minute vwap ) * 100 ) / [-15] 1 minute vwap < .1 and ( ( [-10] 1 minute vwap - [-20] 1 minute vwap ) * 100 ) / [-20] 1 minute vwap < .1 and ( ( [-10] 1 minute vwap - [-15] 1 minute vwap ) * 100 ) / [-15] 1 minute vwap > -0.1 and ( ( [-10] 1 minute vwap - [-20] 1 minute vwap ) * 100 ) / [-20] 1 minute vwap > -0.1 ) ) and ( {cash} ( [=1] 5 minute close > [=1] 5 minute open and [0] 5 minute high > [=1] 5 minute high and [0] 5 minute high > [=2] 5 minute high and [0] 5 minute high > [=3] 5 minute high and [0] 5 minute high > [=4] 5 minute high and [=1] 30 minute low > [=-2] 15 minute low and ( ( ( [0] 5 minute high - 1 day ago close ) * 100 ) / 1 day ago close ) < 3 and ( ( ( [=1] 5 minute high - 1 day ago close ) * 100 ) / 1 day ago close ) < 3 and latest close > 100 and 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" > 1 and abs ( 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" ) > 1 ) ) ) ) ) )
