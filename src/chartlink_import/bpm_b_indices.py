...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_14_00):
        if (sb.nw >= time_10_05 and sb.nw <= time_10_25):
            # ( {33489} ( ( {cash} ( [-1] 5 minute close > [-5] 5 minute high and [-1] 5 minute close > [=2] 5 minute high and [-3] 5 minute close < [=1] 5 minute high and [=1] 30 minute low < 1 day ago close and ( ( ( 1 day ago close - 1 day ago open ) * 100 ) / 1 day ago open ) < 2 and [-1] 5 minute low > [=1] 15 minute low and [-1] 10 minute low > [=1] 15 minute low and [=2] 5 minute high > 1 day ago close and ( ( ( [-1] 5 minute close - [-5] 5 minute close ) * 100 ) / [=1] 5 minute open ) > 0.3 and ( ( ( [-1] 5 minute close - [=1] 5 minute low ) * 100 ) / [=1] 5 minute open ) > 1 and [=1] 15 minute low = [=1] 45 minute low and [-1] 5 minute high > [=2] 5 minute high and ( ( ( [-1] 5 minute close - [-2] 5 minute open ) * 100 ) / [=1] 5 minute open ) < 0.7 and ( ( ( [-1] 5 minute close - [-3] 5 minute open ) * 100 ) / [=1] 5 minute open ) < 1 and ( ( ( [-1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) > -0.3 ) ) ) )
            process_url_volBreakout('https://chartink.com/screener/buy-morning-down-0', '09_30:checkChartBuy/Sell-morningDown(LastDaybeforeGT0-OR-MidacpCrossedMorningHigh)', time_10_05, time_10_25)
        if (sb.nw >= time_11_15 and sb.nw <= time_13_00):
            process_url_volBreakout('https://chartink.com/screener/buy-morning-down-0', '09_30:checkChartBuy/Sell-morningDown(LastDaybeforeGT0-OR-MidacpCrossedMorningHigh)', time_11_15, time_13_00)

        if (sb.nw >= time_10_05 and sb.nw <= time_10_25):
            # ( {33489} ( ( {cash} ( [-1] 5 minute close > [-5] 5 minute high and [-1] 5 minute close > [=1] 5 minute high and [-3] 5 minute close < [=1] 5 minute high and [=1] 30 minute low < 1 day ago close and ( ( ( 1 day ago close - 1 day ago open ) * 100 ) / 1 day ago open ) < 2 and [-1] 5 minute low > [=1] 15 minute low and [-1] 10 minute low > [=1] 15 minute low and [=2] 5 minute high > 1 day ago close and ( ( ( [-1] 5 minute close - [-5] 5 minute close ) * 100 ) / [=1] 5 minute open ) > 0.3 and ( ( ( [=1] 30 minute low - 1 day ago close ) * 100 ) / 1 day ago close ) < -0.5 and ( ( ( 1 day ago close - [=1] 30 minute low ) * 100 ) / 1 day ago close ) > 0 and [=1] 30 minute low < 1 day ago close and [=1] 15 minute low < 2 days ago high and 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" > 0 and ( ( ( [-1] 5 minute close - [-2] 5 minute open ) * 100 ) / [=1] 5 minute open ) < 0.7 and ( ( ( [-1] 5 minute close - [-3] 5 minute open ) * 100 ) / [=1] 5 minute open ) < 1 ) ) ) )
            process_url_volBreakout('https://chartink.com/screener/buy-check-morning-down-breakup-01', 'buy-check-morning-down-breakup-01', time_10_05, time_10_25)
        if (sb.nw >= time_11_15 and sb.nw <= time_12_00):
            process_url_volBreakout('https://chartink.com/screener/buy-check-morning-down-breakup-01','buy-check-morning-down-breakup-01', time_11_15, time_12_00)
        ...
        if (sb.nw >= time_09_45 and sb.nw <= time_11_30):
            # ( {33489} ( ( {cash} ( ( ( ( [0] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) > 1 and ( ( ( [=1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) < 4 and ( ( ( [-1] 5 minute close - [=1] 5 minute open ) * 100 ) / 1 day ago close ) > 0.75 and ( ( ( weekly high - 1 day ago high ) * 100 ) / 1 day ago close ) > 0.5 and ( ( ( 1 week ago high - [=1] 5 minute high ) * 100 ) / 1 day ago close ) > 0 and ( ( ( 1 week ago high - 1 day ago high ) * 100 ) / 1 day ago close ) > 0 and ( [=1] 15 minute high - [-1] 5 minute high ) < ( [-1] 5 minute low - [=1] 15 minute low ) and [-1] 5 minute close > [=2] 5 minute open and [-1] 5 minute close > [=2] 5 minute close and [0] 15 minute low > [=2] 5 minute open and [0] 15 minute low > [=2] 5 minute open ) ) and ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 30  ) and ( ( ( [-1] 5 minute close - [-2] 5 minute open ) * 100 ) / [=1] 5 minute open ) < 0.7 and ( ( ( [-1] 5 minute close - [-3] 5 minute open ) * 100 ) / [=1] 5 minute open ) < 0.9 and ( ( ( [-1] 5 minute close - [-4] 5 minute open ) * 100 ) / [=1] 5 minute open ) < 1 ) ) ) )
            process_url_volBreakout('https://chartink.com/screener/buy-morning-volume-breakout-checknews', 'buy-morning-volume-breakout(Check-News)', time_09_45, time_11_00)
