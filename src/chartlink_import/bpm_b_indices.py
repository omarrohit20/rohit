...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_12_00):
        ...
        if (sb.nw >= time_09_45 and sb.nw <= time_11_00):
            ...
            process_url_volBreakout('https://chartink.com/screener/buy-morning-volume-breakout-checknews', 'buy-morning-volume-breakout(Check-News)', time_09_50, time_10_45)

        if (sb.nw >= time_10_00 and sb.nw <= time_12_00):
            # ( {57960} ( ( {cash} ( ( ( ( [-1] 5 minute high - 1 day ago high ) * 100 ) / 1 day ago close ) > -0.5 and ( ( ( [-1] 5 minute high - 2 days ago high ) * 100 ) / 1 day ago close ) > -0.5 and ( ( ( [=1] 30 minute high - 1 day ago open ) * 100 ) / 1 day ago close ) < 3 and ( ( ( [-1] 5 minute high - 2 days ago close ) * 100 ) / 1 day ago close ) < 3 and ( ( ( [-1] 5 minute high - 1 day ago close ) * 100 ) / 1 day ago close ) < 2 and ( ( ( [-1] 5 minute high - [=1] 5 minute open ) * 100 ) / 1 day ago close ) < 2 and ( ( ( [-1] 5 minute close - [=1] 10 minute high ) * 100 ) / 1 day ago close ) > 0 and ( ( ( [-1] 5 minute close - [=1] 5 minute open ) * 100 ) / 1 day ago close ) > 0.7 and ( ( ( [-1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) > 1.3 and ( ( ( [=1] 15 minute high - 1 day ago close ) * 100 ) / 1 day ago close ) < 1.3 and ( ( ( 1 day ago high - 1 day ago close ) * 100 ) / 1 day ago close ) < 1.5 and ( ( ( 1 day ago close - 1 day ago open ) * 100 ) / 1 day ago close ) < 2 and ( ( ( [=1] 1 hour low - 1 day ago close ) * 100 ) / 1 day ago close ) > -0.5 and ( ( ( [=1] 1 hour high - [-1] 15 minute high ) * 100 ) / 1 day ago close ) < 0.5 and 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" > -0.5 and weekly "close - 1 candle ago close / 1 candle ago close * 100" > 0 and monthly "close - 1 candle ago close / 1 candle ago close * 100" > 0 and 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" > -2 and [-1] 5 minute close > [=1] 10 minute high and ( ( ( [-1] 5 minute close - [-2] 5 minute open ) * 100 ) / [=1] 5 minute open ) < 0.7 and ( ( ( [-1] 5 minute close - [-3] 5 minute low ) * 100 ) / [=1] 5 minute open ) < 0.9 ) ) ) )
            process_url_volBreakout('https://chartink.com/screener/buy-dayconsolidation-breakout-04', 'buy-breakout', time_10_00, time_12_00)
