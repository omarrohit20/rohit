...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_14_00):
        if (sb.nw >= time_09_30 and sb.nw <= time_10_00):
            # ( {33489} ( ( {cash} ( ( ( ( [=1] 15 minute low - 1 day ago close ) * 100 ) / [=1] 5 minute open ) < -1 and ( ( ( [=1] 5 minute low - [=1] 15 minute open ) * 100 ) / [=1] 5 minute open ) < 0 and ( ( ( [-1] 5 minute close - [-3] 5 minute open ) * 100 ) / [=1] 5 minute open ) > 0.5 and ( [0] 5 minute high - [=1] 10 minute low ) > ( 1 day ago close - [0] 5 minute high ) and ( ( ( [-1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) > -0.5 and ( ( ( [-1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) < 0 and ( ( ( [-1] 5 minute close - [=1] 5 minute open ) * 100 ) / 1 day ago close ) > 0 and ( ( ( [=1] 5 minute high - [=1] 5 minute low ) * 100 ) / 1 day ago close ) < 2 and [0] 5 minute close > [=3] 5 minute high and 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" > -2 and 2 days ago "close - 1 candle ago close / 1 candle ago close * 100" > -1.5 and 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" < 2 and ( ( ( [=-1] 5 minute low - [=-3] 1 hour open ) * 100 ) / [=1] 5 minute open ) > -1 and [=1] 5 minute close > 3 days ago low ) ) ) )
