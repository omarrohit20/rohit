...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_12_00):
        ...
        if (sb.nw >= time_09_45 and sb.nw <= time_10_15):
            # ( {33489} ( ( {cash} ( [=1] 5 minute high > [=1] 5 minute vwap and [=1] 5 minute high > [=1] 5 minute ema ( [0] 5 minute close , 20 ) ) ) and ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 24  ) and [=1] 5 minute volume > greatest(  2 days ago volume / 24  ) and latest "close - 1 candle ago close / 1 candle ago close * 100" > 0.5 and ( ( ( [=1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) > 1 ) ) and ( {cash} ( ( ( ( [-1] 5 minute close - [-6] 5 minute close ) * 100 ) / [-6] 5 minute close ) > 0 and ( ( ( [=1] 15 minute high - [-1] 5 minute close ) * 100 ) / [-1] 5 minute close ) < 0.3 ) ) and ( {cash} ( [=1] 2 minute volume > greatest(  1 day ago volume / 24  ) and [=1] 2 minute volume > greatest(  2 days ago volume / 24  ) and latest "close - 1 candle ago close / 1 candle ago close * 100" > 0.5 and ( ( ( [=1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) > 0.5 ) ) ) )
            process_url_volBreakout('https://chartink.com/screener/morning-volume-breakout-buy-2', 'buy-morning-volume-breakout', time_09_45, time_10_00)
