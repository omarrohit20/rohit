...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_13_30):             
        ...
        if(sb.nw>= time_10_00 and sb.nw <= time_11_30):
            #( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 24  ) and [=1] 15 minute volume > greatest(  1 day ago volume / 18  ) and [=1] 5 minute volume > greatest(  2 days ago volume / 24  ) and [-1] 5 minute high > [-1] 5 minute vwap and [-2] 5 minute high > [-2] 5 minute vwap and [-3] 5 minute high > [-3] 5 minute vwap and ( ( ( [-1] 5 minute close - 1 day ago close ) * 100 ) / [-5] 5 minute high ) < 2.5 and ( ( ( [-1] 5 minute close - 1 day ago close ) * 100 ) / [-5] 5 minute high ) > 1 and ( ( ( [-1] 5 minute close - [=1] 5 minute high ) * 100 ) / [=1] 5 minute high ) < 0 and ( ( ( [=2] 5 minute low - [0] 3 hour low ) * 100 ) / [=2] 5 minute low ) < 0 ) ) 
            process_url_volBreakout('https://chartink.com/screener/buy-morning-down-1', 'buy-morningbreakout-down-VWAP-1-10', time_10_00, time_11_30)
