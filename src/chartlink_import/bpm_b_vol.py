...
if __name__ == "__main__":
    ...
    with sync_playwright() as p:
        context = p.chromium.launch_persistent_context(
            user_data_dir=str(script_directory / "profiles" / "p7"),
            headless=False,
        ...
        while (sb.nw <= time_11_15):
            ...
            if (sb.nw >= time_09_22 and sb.nw <= time_11_00):
                # ( {33489} ( ( {cash} (  [=1] 5 minute volume >  greatest(   1 day ago volume /  30  ) and  [=1] 10 minute volume >  greatest(   1 day ago volume /  22  ) and  [=1] 15 minute volume >  greatest(   1 day ago volume /  15  ) and  (  (  (  [0] 5 minute close -  [=1] 5 minute open ) *  100 ) /  [=1] 5 minute open ) >  0.6 and  (  (  (  [0] 5 minute high -  [=-1] 5 minute close ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  (  (  (  [-1] 5 minute high -  1 day ago close ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  (  (  (  [-1] 5 minute close -  1 day ago close ) *  100 ) /  [=1] 5 minute open ) >  1 and  (  (  (  [0] 5 minute close -  1 day ago close ) *  100 ) /  [=1] 5 minute open ) >  0.8 and ( {cash} (  (  (  (  [=1] 5 minute close -  [=1] 5 minute open ) *  100 ) /  [=1] 5 minute open ) >  0.3 or  (  (  (  [=2] 5 minute close -  [=1] 5 minute open ) *  100 ) /  [=1] 5 minute open ) >  -0.3 or  (  (  (  [=1] 5 minute high -  [=3] 5 minute low ) *  100 ) /  [=1] 5 minute open ) <  1 or ( {cash} (  [=4] 5 minute high <  [=1] 5 minute high and  [=5] 5 minute high <  [=1] 5 minute high and  [=6] 5 minute high <  [=1] 5 minute high ) ) ) ) and  daily close >  50 ) ) ) )
            ...
            if (sb.nw >= time_09_15 and sb.nw <= time_09_40):
                # ( {57960} ( ( {cash} (  [=1] 5 minute volume >  [=-5] 5 minute volume and  [=1] 5 minute volume >  [=-4] 5 minute volume and  [=1] 5 minute volume >  [=-3] 5 minute volume and  [=1] 5 minute volume >  [=-2] 5 minute volume and  [=1] 5 minute volume >  [=-1] 5 minute volume and  [=1] 5 minute volume <  [=-1] 5 minute volume *  2 and  [=1] 5 minute volume >  greatest(   1 day ago volume /  22  ) and  [=1] 10 minute volume >  greatest(   1 day ago volume /  22  ) and  [=1] 15 minute volume >  greatest(   1 day ago volume /  15  ) and  [=1] 5 minute "close - 1 candle ago close / 1 candle ago close * 100" <  1.5 and  abs (  1 day ago "close - 1 candle ago close / 1 candle ago close * 100" ) <  3 and  daily close >  50 and ( {cash} (  [=1] 5 minute low >  [=-1] 5 minute open and  abs (  (  (  [0] 5 minute close -  [=1] 5 minute open ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  abs (  (  (  [0] 5 minute low -  [=-1] 5 minute close ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  abs (  (  (  [-1] 5 minute low -  1 day ago close ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  abs (  (  (  1 day ago close -  1 day ago open ) *  100 ) /  [=1] 5 minute open ) <  1.5 ) ) and ( {cash} (  abs (  (  (  [0] 5 minute close -  [=1] 5 minute open ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  abs (  (  (  [0] 5 minute high -  [=-1] 5 minute close ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  abs (  (  (  [-1] 5 minute high -  1 day ago close ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  abs (  (  (  1 day ago close -  1 day ago open ) *  100 ) /  [=1] 5 minute open ) <  1.5 ) ) and ( {cash} (  (  (  (  [-1] 5 minute close -  [=1] 5 minute open ) *  100 ) /  1 day ago close ) <  0.5 or  (  (  (  [-1] 5 minute close -  1 day ago close ) *  100 ) /  1 day ago close ) <  1 or  [=1] 5 minute open <  1 day ago high or  [=1] 5 minute close <  2 days ago close ) ) ) ) ) ) 
                process_url_volBreakout('https://chartink.com/screener/morning-volume-breakout-buy-4', 'breakout-morning-beey', time_09_15, time_09_30)
