    ...
    with sync_playwright() as p:
        ...
        while (sb.nw <= time_11_15):
            ...
            if (sb.nw >= time_09_22 and sb.nw <= time_11_00):
                # ( {33489} ( ( {cash} (  [=1] 5 minute volume >  greatest(   1 day ago volume /  30  ) and  [=1] 10 minute volume >  greatest(   1 day ago volume /  22  ) and  [=1] 15 minute volume >  greatest(   1 day ago volume /  15  ) and  (  (  (  [0] 5 minute close -  [=1] 5 minute open ) *  100 ) /  [=1] 5 minute open ) >  0.6 and  (  (  (  [0] 5 minute high -  [=-1] 5 minute close ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  (  (  (  [-1] 5 minute high -  1 day ago close ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  (  (  (  [-1] 5 minute close -  1 day ago close ) *  100 ) /  [=1] 5 minute open ) >  1 and  (  (  (  [0] 5 minute close -  1 day ago close ) *  100 ) /  [=1] 5 minute open ) >  0.8 and  daily close >  50 ) ) ) ) 
