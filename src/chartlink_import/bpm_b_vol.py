...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_13_30):             
        ...
        if(sb.nw>= time_11_30 and sb.nw <= time_12_15):
            #( {cash} ( abs ( ( ( [=1] 5 minute close - [=1] 5 minute open ) * 100 ) / [=1] 5 minute open ) > 0.1 and ( ( ( [-1] 5 minute close - [-6] 5 minute close ) * 100 ) / [-6] 5 minute close ) > 0.3 and ( ( ( [=1] 30 minute high - [=1] 5 minute open ) * 100 ) / [=1] 5 minute open ) > 0.75 and [0] 15 minute "close - 1 candle ago close / 1 candle ago close * 100" > 0 and [-1] 30 minute "close - 1 candle ago close / 1 candle ago close * 100" > 0 and [-1] 1 hour "close - 1 candle ago close / 1 candle ago close * 100" > 0 and [-1] 5 minute high < [=1] 30 minute high and [-1] 5 minute low > [-1] 5 minute ema ( [0] 5 minute close , 50 ) and [-3] 5 minute low > [-3] 5 minute ema ( [-3] 5 minute close , 50 ) and [-6] 5 minute low > [-6] 5 minute ema ( [-6] 5 minute close , 50 ) and [-12] 5 minute low > [-12] 5 minute ema ( [0] 5 minute close , 50 ) and [-1] 5 minute low > [-1] 5 minute sma ( [-1] 5 minute close , 50 ) and [-3] 5 minute low > [-3] 5 minute sma ( [-3] 5 minute close , 50 ) and [-6] 5 minute low > [-6] 5 minute sma ( [-6] 5 minute close , 50 ) and [-1] 5 minute sma ( [-1] 5 minute close , 50 ) > [-3] 5 minute sma ( [-3] 5 minute close , 50 ) and [-3] 5 minute sma ( [-3] 5 minute close , 50 ) > [-6] 5 minute sma ( [-6] 5 minute close , 50 ) and [-1] 5 minute ema ( [-1] 5 minute close , 50 ) > [-3] 5 minute ema ( [-3] 5 minute close , 50 ) and [-3] 5 minute ema ( [-3] 5 minute close , 50 ) > [-6] 5 minute ema ( [-6] 5 minute close , 50 ) and [-6] 5 minute ema ( [-6] 5 minute close , 50 ) > [-12] 5 minute ema ( [-12] 5 minute close , 50 ) and [-12] 5 minute ema ( [-12] 5 minute close , 50 ) > [-24] 5 minute ema ( [-24] 5 minute close , 50 ) and ( ( ( [-1] 15 minute low - 1 day ago close ) * 100 ) / 1 day ago open ) > 0 and ( ( ( [-1] 15 minute low - 1 day ago close ) * 100 ) / 1 day ago open ) < 3 and ( ( ( [=1] 5 minute open - 2 days ago open ) * 100 ) / 2 days ago open ) < 5 and ( ( ( [=1] 5 minute open - 1 day ago open ) * 100 ) / 1 day ago open ) < 4 and ( ( ( [=1] 30 minute high - [=1] 5 minute open ) * 100 ) / [=1] 5 minute open ) < 3 and ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 24  ) and [=1] 15 minute volume > greatest(  1 day ago volume / 18  ) and [=1] 5 minute volume > greatest(  2 days ago volume / 24  ) ) ) ) ) 
