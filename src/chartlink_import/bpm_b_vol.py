...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_11_00):
        ...
        if (sb.nw >= time_09_30 and sb.nw <= time_10_00):
            ...
            process_url_volBreakout('https://chartink.com/screener/buy-morning-volume-breakout-checknews-01', 'buy-morning-volume-breakout(Check-News)-01', time_09_25, time_10_00)
        ...
        if(sb.nw>= time_09_20 and sb.nw <= time_09_45):
            # ( {cash} ( ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 24  ) and [=1] 15 minute volume > greatest(  1 day ago volume / 18  ) and [=1] 5 minute volume > greatest(  2 days ago volume / 24  ) and [=1] 5 minute close > [=1] 5 minute open and [=1] 5 minute close > 1 day ago close and market cap > 1000 and latest close < 5000 and [=1] 5 minute high > 1 day ago close and [=1] 5 minute high > 2 days ago high and [=1] 5 minute high > 3 days ago high and [=1] 5 minute high > 4 days ago high and [=1] 5 minute high > 5 days ago high and [=2] 5 minute low > 3 days ago high and [=2] 5 minute low > 4 days ago high and [=2] 5 minute low > 5 days ago high and ( ( ( [=-1] 5 minute high - [=-75] 5 minute high ) * 100 ) / 1 day ago close ) < 4 and ( ( ( [=2] 5 minute close - [=1] 5 minute open ) * 100 ) / 1 day ago close ) > 0.75 and 1 day ago "close - 1 candle ago close / 1 candle ago close * 100" < 1.5 ) ) ) )
