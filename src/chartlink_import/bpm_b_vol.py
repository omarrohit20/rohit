...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_11_00):
        ...
        if (sb.nw >= time_09_30 and sb.nw <= time_11_00):
            #( {33489} ( ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 30  ) and [=1] 10 minute volume > greatest(  1 day ago volume / 22  ) and [=1] 15 minute volume > greatest(  1 day ago volume / 18  ) and ( ( ( [=2] 10 minute high - [=1] 5 minute open ) * 100 ) / [=1] 5 minute open ) < 3 and ( ( ( [=1] 15 minute close - [=1] 15 minute open ) * 100 ) / [=1] 5 minute open ) < 2 and ( ( ( [=1] 30 minute high - 1 day ago close ) * 100 ) / [=1] 5 minute open ) < 3 and ( ( ( [=1] 30 minute high - [=1] 30 minute low ) * 100 ) / [=1] 5 minute open ) < 3 and ( ( ( [-1] 5 minute close - [=1] 5 minute open ) * 100 ) / [=1] 5 minute open ) > 0.6 and ( ( ( [=1] 15 minute close - [=1] 5 minute open ) * 100 ) / [=1] 5 minute open ) > 0.3 and ( ( ( [-1] 5 minute high - [=-1] 5 minute high ) * 100 ) / [=1] 5 minute open ) > 0 and ( ( ( [=1] 15 minute close - 1 day ago close ) * 100 ) / [=1] 5 minute open ) > -0.3 and ( ( ( [=1] 15 minute high - 1 day ago close ) * 100 ) / [=1] 5 minute open ) > -0.3 and ( ( ( [-1] 5 minute close - 1 day ago close ) * 100 ) / [=1] 5 minute open ) > 1.3 and ( ( ( [=1] 5 minute close - 2 days ago open ) * 100 ) / 2 days ago open ) < 4 and ( ( ( [=1] 5 minute close - 2 days ago low ) * 100 ) / 2 days ago low ) < 5 and ( ( ( 1 day ago close - 1 day ago open ) * 100 ) / 1 day ago close ) < 3 and ( ( ( 1 day ago close - 1 day ago low ) * 100 ) / 1 day ago close ) < 3 and ( ( ( 1 day ago close - 3 days ago close ) * 100 ) / 1 day ago close ) > -3 and latest low = [=1] 15 minute low and [-1] 5 minute high > [=2] 5 minute low and [-2] 5 minute high > [=2] 5 minute low and [-3] 5 minute high > [=2] 5 minute low and [-4] 5 minute high > [=2] 5 minute low and abs ( [=2] 10 minute high - [=2] 5 minute high ) < abs ( [=2] 5 minute high - 1 day ago close ) ) ) ) )
        ...
        if (sb.nw >= time_09_40 and sb.nw <= time_11_00):
            ...
            process_url_volBreakout('https://chartink.com/screener/buy-morning-volume-breakout-checknews-02', 'buy-morning-volume-breakout(Check-News)-01', time_09_50, time_11_00)
