...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_13_30):
        ...
        if(sb.nw>= time_09_25 and sb.nw <= time_09_30):
            #( {33489} ( ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 24  ) and [=1] 15 minute volume > greatest(  1 day ago volume / 18  ) and [=1] 5 minute volume > greatest(  2 days ago volume / 24  ) and abs ( ( ( [=1] 5 minute close - [=1] 5 minute open ) * 100 ) / [=1] 5 minute open ) > 0.7 and abs ( ( ( [=1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) < 2 and abs ( ( ( [=1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) > 1.2 ) ) and ( {cash} ( [=1] 5 minute close > [=1] 5 minute open and [=1] 5 minute close > [=-1] 5 minute high and [=1] 5 minute high > [=1] 5 minute vwap and [=1] 5 minute high > [=1] 5 minute ema ( [0] 5 minute close , 20 ) and [=1] 5 minute high > [=-1] 15 minute low and [=1] 5 minute close > [=-1] 15 minute close ) ) ) )
