...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_10_30):
        ...
        if (sb.nw >= time_09_40 and sb.nw <= time_10_30):
            # ( {57960} ( ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 12  ) and [=1] 15 minute volume > greatest(  1 day ago volume / 18  ) and [=1] 5 minute volume > greatest(  2 days ago volume / 24  ) and [=1] 5 minute high > [=1] 5 minute sma ( [=1] 5 minute close , 200 ) and [=1] 5 minute close > [=1] 5 minute open and [=1] 5 minute close > 1 day ago close and ( ( ( [=2] 5 minute low - 1 day ago close ) * 100 ) / 1 day ago close ) > 0.5 and ( ( ( [=1] 5 minute close - 1 day ago close ) * 100 ) / 1 day ago close ) > 0.5 and ( ( ( [=1] 5 minute close - [=1] 5 minute open ) * 100 ) / 1 day ago close ) > 0.1 and ( ( ( 1 day ago close - 2 days ago open ) * 100 ) / 1 day ago close ) < 6 and [=1] 5 minute high > 2 days ago close and 1 day ago close > 3 days ago close and ( {cash} ( [=2] 5 minute high > [=1] 5 minute high and [-1] 5 minute high > [=3] 5 minute close and [-1] 5 minute high > [=3] 5 minute open and [-1] 5 minute high > [=1] 5 minute open and [-1] 5 minute high > [=1] 5 minute close and [-1] 5 minute low > [-1] 5 minute vwap ) ) ) ) ) )
            process_url_volBreakout('https://chartink.com/screener/morning-volume-breakout-1-2', 'buy-morning-up-volume-breakout', time_09_45, time_10_15)
