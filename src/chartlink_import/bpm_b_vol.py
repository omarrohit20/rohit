...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_11_15):
        ...
        if (sb.nw >= time_10_00 and sb.nw <= time_11_00):
            # ( {33489} ( ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 22  ) and ( ( ( [=1] 30 minute high - 1 day ago close ) * 100 ) / [=1] 5 minute open ) > 1.5 and ( ( ( [-1] 5 minute close - 1 day ago close ) * 100 ) / [=1] 5 minute open ) > 1.3 and ( ( ( [=1] 15 minute close - [=1] 5 minute open ) * 100 ) / [=1] 5 minute open ) < 2 and ( ( ( [=1] 5 minute close - 1 day ago close ) * 100 ) / [=1] 5 minute open ) < 2.5 and ( ( ( [=1] 20 minute high - 1 day ago close ) * 100 ) / [=1] 5 minute open ) < 3.5 and ( ( ( [=1] 20 minute high - [-1] 15 minute low ) * 100 ) / [=1] 5 minute open ) < 1 and ( ( ( [=1] 20 minute high - [-2] 15 minute low ) * 100 ) / [=1] 5 minute open ) < 1 and ( ( ( [=1] 45 minute high - [=4] 5 minute close ) * 100 ) / [=1] 5 minute open ) < 0.7 and ( ( ( [=1] 45 minute high - [=1] 5 minute open ) * 100 ) / [=1] 5 minute open ) < 2 and [-1] 5 minute low > [=2] 3 minute low and [-2] 15 minute low > [=2] 3 minute low and [-3] 15 minute low > [=2] 3 minute low and [-1] 5 minute high < [=1] 15 minute high and [-1] 5 minute high > [=1] 3 minute high and [=1] 45 minute high <= [=1] 30 minute high and 2 days ago "close - 1 candle ago close / 1 candle ago close * 100" < 1.5 and 2 days ago "close - 1 candle ago close / 1 candle ago close * 100" > -2 ) ) ) ) 
            process_url_volBreakout('https://chartink.com/screener/morning-volume-breakout-buy-3', 'Breakout-Buy-after-10',time_10_00, time_11_00)
