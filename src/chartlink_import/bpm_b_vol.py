...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_12_15):
        if (sb.nw >= time_09_23 and sb.nw <= time_10_00):
            # ( {33489} ( ( {cash} ( [=1] 5 minute volume > greatest(  1 day ago volume / 30  ) and [=1] 10 minute volume > greatest(  1 day ago volume / 22  ) and [=1] 15 minute volume > greatest(  1 day ago volume / 15  ) and ( ( ( [0] 5 minute close - [=1] 5 minute open ) * 100 ) / [=1] 5 minute open ) > 0.6 and ( ( ( [0] 5 minute high - [=-1] 5 minute close ) * 100 ) / [=1] 5 minute open ) > 0.5 and ( ( ( [=1] 15 minute high - 1 day ago close ) * 100 ) / [=1] 5 minute open ) > -0.3 and ( ( ( [-1] 5 minute high - 1 day ago close ) * 100 ) / [=1] 5 minute open ) > 0.5 and ( ( ( [=1] 15 minute high - 1 day ago close ) * 100 ) / [=1] 5 minute open ) > 0 and ( ( ( [=1] 5 minute open - 1 day ago close ) * 100 ) / [=1] 5 minute open ) > -0.5 and ( ( ( [=1] 5 minute open - [=-1] 5 minute low ) * 100 ) / [=1] 5 minute open ) > -0.1 and ( ( ( [0] 5 minute high - 1 day ago close ) * 100 ) / [=1] 5 minute open ) > 1 ) ) ) )
