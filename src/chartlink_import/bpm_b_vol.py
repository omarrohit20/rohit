    ...
    with sync_playwright() as p:
        ...
        while (sb.nw <= time_11_15):
            ...
            if (sb.nw >= time_09_15 and sb.nw <= time_09_40):
                # ( {57960} ( ( {cash} (  [=1] 5 minute volume >  [=-5] 5 minute volume and  [=1] 5 minute volume >  [=-4] 5 minute volume and  [=1] 5 minute volume >  [=-3] 5 minute volume and  [=1] 5 minute volume >  [=-2] 5 minute volume and  [=1] 5 minute volume >  [=-1] 5 minute volume and  [=1] 5 minute volume <  [=-1] 5 minute volume *  2 and  [=1] 5 minute volume >  greatest(   1 day ago volume /  22  ) and  [=1] 10 minute volume >  greatest(   1 day ago volume /  22  ) and  [=1] 15 minute volume >  greatest(   1 day ago volume /  15  ) and  [=1] 5 minute "close - 1 candle ago close / 1 candle ago close * 100" <  1.5 and  abs (  1 day ago "close - 1 candle ago close / 1 candle ago close * 100" ) <  3 and  daily close >  50 and ( {cash} (  [=1] 5 minute low >  [=-1] 5 minute open and  abs (  (  (  [0] 5 minute close -  [=1] 5 minute open ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  abs (  (  (  [0] 5 minute low -  [=-1] 5 minute close ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  abs (  (  (  [-1] 5 minute low -  1 day ago close ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  abs (  (  (  1 day ago close -  1 day ago open ) *  100 ) /  [=1] 5 minute open ) <  1.5 ) ) and ( {cash} (  abs (  (  (  [0] 5 minute close -  [=1] 5 minute open ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  abs (  (  (  [0] 5 minute high -  [=-1] 5 minute close ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  abs (  (  (  [-1] 5 minute high -  1 day ago close ) *  100 ) /  [=1] 5 minute open ) >  0.5 and  abs (  (  (  1 day ago close -  1 day ago open ) *  100 ) /  [=1] 5 minute open ) <  1.5 ) ) ) ) ) ) 
