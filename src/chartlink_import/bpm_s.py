...
if __name__ == "__main__":
    ...
    while (sb.nw <= time_14_00):    
        ...
        if(sb.nw>= time_11_30 and sb.nw <= time_13_30):    
            #( {33489} ( ( {cash} ( [-1] 5 minute low > [=1] 5 minute low and [-1] 5 minute low > [=1] 15 minute low and [-1] 30 minute "close - 1 candle ago close / 1 candle ago close * 100" < -0.3 and [-1] 15 minute "close - 1 candle ago close / 1 candle ago close * 100" < -0.3 and [=1] 1 hour high > [=-1] 5 minute low and [=1] 30 minute high = [=1] 1 hour high and [-1] 10 minute high < [=1] 15 minute high and ( ( [-1] 5 minute close - [=1] 5 minute open ) * 100 ) / [=1] 5 minute open > -2 and ( ( [-1] 5 minute close - [=1] 5 minute open ) * 100 ) / [=1] 5 minute open < 2 and ( ( [-1] 5 minute close - [=1] 5 minute high ) * 100 ) / [=1] 5 minute high > -2 ) ) ) ) 
