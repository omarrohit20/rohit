...
Feature: Moneycontrol news extractor
  ...
  Scenario Outline: get news link
    Given User navigate to http://www.moneycontrol.com/
    And User search company <symbol> and navigate to page
    And User click on news link
    And User get news url company <company>, symbol <symbol>
  Examples:
    |	company	|	symbol	|
#    |	ACC LIMITED	|	ACC	|
...
#  |	INFIBEAM INCORPORATION LIMITED	|	INFIBEAM	|
...
#  |	SUN PHARMACEUTICALS IND.	|	SUNPHARMA	|
